                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-lg table-v2 table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img alt="" src="{{asset('assets')}}/img/flags-icons/us.png" width="25px" />
                                </td>
                                <td class="text-right">
                                    $245
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img alt="" src="{{asset('assets')}}/img/flags-icons/fr.png" width="25px" />
                                </td>
                                <td class="text-right">
                                    $154
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img alt="" src="{{asset('assets')}}/img/flags-icons/ca.png" width="25px" />
                                </td>
                                <td class="text-right">
                                    $112
                                </td>
